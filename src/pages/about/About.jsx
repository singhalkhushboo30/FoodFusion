...
class About extends React.Component {
    ...
    async componentDidMount() {
        try {
            const response = await fetch("https://api.github.com/users/singhalkhushboo30");
            ...
            <div className="about">
                    ...
                    <div className="about-me-body">
                        ...
                        <div className="about-me-details">
                            ...
                            <div className="about-me-links">
                                <Link
                                    to={"https://github.com/singhalkhushboo30"}
                                    target="_blank"
                                    className="btn"
                                >
                                    <Github size={"1rem"} />
                                ...
                                <Link
                                    to={"https://github.com/singhalkhushboo30/FoodFusion"}
                                    target="_blank"
                                    className="btn"
                                >
                                    <Code2Icon size={"1rem"} />
                ...
                <div className="about-project">
                    ...
                    <div className="about-project-text">
                        <span>
                            FoodFusion is a food-ordering website that is built on top of the Swiggy
                            API, a well-renowned food ordering platform. By seamlessly integrating
                            technology with culinary expertise, FoodFusion aims to provide users
                        ...
                        <span>
                            ...
                            traditional comfort food or exotic international flavors, FoodFusion has
